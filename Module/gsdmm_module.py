...
# AllTextSet = EnglishWE['Word'].tolist()[:20]
# EnglishWEa = {k:v for k,v in zip(AllTextSet,[[float(i) for i in EnglishWE[EnglishWE['Word'] == ThisWord]['WE'].values[0].strip("'").split(',')] for ThisWord in AllTextSet])}
# EnglishWEa
